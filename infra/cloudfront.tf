...
resource "aws_cloudfront_distribution" "www_s3_distribution" {
  ...
  viewer_certificate {
    acm_certificate_arn      = aws_acm_certificate_validation.cert_validation_www.certificate_arn
...
resource "aws_cloudfront_distribution" "root_s3_distribution" {
  ...
  viewer_certificate {
    acm_certificate_arn      = aws_acm_certificate_validation.cert_validation_root.certificate_arn
    ssl_support_method       = "sni-only"
    minimum_protocol_version = "TLSv1.1_2016"
  }
